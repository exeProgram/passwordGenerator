const passText = document.getElementById("password-smalltext");
...
const passWordLengthSliderMaximum = 50000000;
const passWordLength = document.getElementById("password-length-number");
const upperCaseCheck = document.getElementById("upper-case-chars") as HTMLInputElement;
const lowerCaseCheck = document.getElementById("lower-case-chars") as HTMLInputElement;
const numbersToggle = document.getElementById("numbers-toggle") as HTMLInputElement;
const specialChars = document.getElementById("special-chars") as HTMLInputElement;
...
function generatePassword(){
    let grabGeneratedPassword:string = passwordGeneration();
